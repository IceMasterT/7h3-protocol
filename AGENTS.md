...
**7h3 Protocol** is a cryptographic signing and replay-protection layer for AI agent messages. It has TypeScript, Python, Rust, and Go SDKs, a Cloudflare Workers gateway, and 566 tests.
